...
- `1.1.0` in documentation and changelog headings
- `1.1.0` as the Git tag and GitHub release name
...
- A matching Git tag, for example `1.1.0`.
...
- Installation examples can use `from: "1.1.0"` once the `1.1.0` tag exists.
